...
d7.on('mouseover', function (e) {
    this.bindPopup(`26일 09시 예상<br>중심기압: 935hPa<br>최대풍속: 49m/s<br>강도: 매우강 <br>진행: 서북서, 16km/h`, {
        offset: [0,0]
    })
    this.openPopup()
});
...
d6.on('mouseover', function (e) {
    this.bindPopup(`25일 09시 예상<br>중심기압: 940hPa<br>최대풍속: 47m/s<br>강도: 매우강 <br>진행: 서북서, 15km/h`, {
        offset: [0,0]
    })
    this.openPopup()
});
